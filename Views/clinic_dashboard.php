...
<body>
	<section class="py-5 my-5">
		<div class="container">
			<h1 class="mb-5">Clinic Dashboard</h1>
			<div class="bg-white shadow rounded-lg d-block d-sm-flex">
				<div class="profile-tab-nav border-right">
					<div class="p-4">
						...
						<h4 class="text-center"><?php echo $_SESSION['name']  ?>
    ...
    if (isset($_SESSION['clinic_id'])) {
        ...
        $stmt = $connection->prepare("SELECT * FROM Feedback WHERE clinic_id = ?");
        ...
        // Handle the case where $_SESSION['clinic_id'] is not set
        echo "<tr><td colspan='3'>clinic ID is not set.</td></tr>";
    }
    ?>
</tbody>
    ...
    <tbody>
       ...
       // session_start();
        ...
        if(isset($_SESSION['clinic_id'])) {
            ...
            try {
                // Prepare the SQL query with parameterized statement
                $stmt = $connection->prepare("SELECT * FROM Appointments WHERE status = ? AND appointment_speciality = ? AND clinic_id IS NULL");
                ...
                <form action="../Controllers/clinic_dashboard.php" method="post">
    ...
    <form action="../Controllers/clinic_dashboard.php" method="post">
        <button type="submit" value="'.$row["appointment_id"].'"  name="decline_appointment" class="btn btn-primary ">Decline </button>
            ...
            // Handle the case where $_SESSION['clinic_id'] is not set
            echo "<tr><td colspan='5'>clinic ID is not set.</td></tr>";
        }
